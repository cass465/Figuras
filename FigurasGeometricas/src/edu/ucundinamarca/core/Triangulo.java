...
public class Triangulo extends Figura{
    ...
    public void definirTipo(byte coordenada1[], byte coordenada2[], byte coordenada3[]){
        ...
        this.lado1 =  (float) Math.sqrt((lado1Cateto1 * lado1Cateto1) + (lado1Cateto2 * lado1Cateto2));
    ...
    public void hallarAltura(float lado1, float lado2, float lado3, String tipo){
        if(tipo.equals("EQUILATERO")){
            ...
            this.altura = (byte) ((2/this.lado1) * (Math.sqrt(semiperimetro*(semiperimetro-lado1)*(semiperimetro-lado2)*(semiperimetro-lado1))));
        }else{
            float cateto = 0;
